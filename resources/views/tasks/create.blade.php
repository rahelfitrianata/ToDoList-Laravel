...
<body class="flex items-center justify-center h-screen bg-cover bg-center" style="background-image: url('/images/bgcredit.png');">
    ...
    <div class="form-edit">
        <h2 class="text-2xl font-bold mb-4 text-center text-purple-700">Add New Task</h2>

        <form action="{{ route('tasks.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
                <label class="block text-gray-700">Task Name</label>
                <input type="text" name="title" class="w-full p-2 border rounded bg-purple-100">
            </div>
            <div>
            ...
            <div class="flex justify-between">
                <button type="submit" class="bg-purple-500 text-white px-4 py-2 rounded">Add</button>
